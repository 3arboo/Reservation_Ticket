...
urlpatterns = [
    ...
    #1
    path('django/jsonresponsenomodel/', views.noresete_nomodel),

    #2 
    path('django/jsonresponsefrommodel/', views.norest_frommodel),
    ...
    path('rest/mixins/<int:pk>', views.mixnis_pk.as_view()),
    ...
    #9 new reservation
    path('fbv/newreservation',views.new_resrvation),
